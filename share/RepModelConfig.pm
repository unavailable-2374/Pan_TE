...
##                                                                      ##
  ...
  $configuration = {
          'CDHIT_DIR' => {
                           ...
                           'required' => 1,
                           'value' => '/public/agis/zhouyongfeng_group/caoshuo/tools/miniconda3/envs/RM/bin'
                         },
          'GENOMETOOLS_DIR' => {
          ...
          'REPEATMASKER_DIR' => {
                                  ...
                                  'param_type' => 'directory',
                                  'required' => 1,
                                  'value' => '/public/agis/zhouyongfeng_group/caoshuo/tools/miniconda3/envs/RM/share/RepeatMasker'
                                },
          'RMBLAST_DIR' => {
