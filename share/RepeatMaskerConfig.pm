...
##                                                                      ##
  ...
  $configuration = {
          'ABBLAST_DIR' => {
                             ...
                             'required' => 0,
                             'value' => '/data/home/zhangfan/micromamba/envs/PGTA/bin'
                           },
          'CROSSMATCH_DIR' => {
          ...
          'LIBDIR' => {
                        ...
                        'param_type' => 'directory',
                        'required' => 0,
                        'value' => '/data/home/zhangfan/micromamba/envs/PGTA/share/RepeatMasker/Libraries'
                      },
          'RMBLAST_DIR' => {
          ...
          'TRF_PRGM' => {
                          ...
                          'param_type' => 'program',
                          'required' => 1,
                          'value' => '/data/home/zhangfan/micromamba/envs/PGTA/bin/trf'
                        }
        };
